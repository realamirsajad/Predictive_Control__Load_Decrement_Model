...
%*****************************************************
%*****************************************************
D1 = 0.015;M1 = 0.1667;R1 = 3   ;B1 = 0.425;Tg1 = 0.08*1.31;Tt1 = 0.40*1.95;
D2 = 0.016;M2 = 0.2017;R2 = 2.73;B2 = 0.425;Tg2 = 0.08*1.66;Tt2 = 0.44*1.38;
...
elim = (g./sum(g))<0.002 %Least order
disp('==============================')
disp('Reduced model:')
